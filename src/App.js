...
class App extends Component {
  ...
  callingAPI = (tags="sun", key="8b900241c78daaf3ef0a69117e40c723".apiKey) => {
    this.setState({loaded: false});
    axios.get(`https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=8b900241c78daaf3ef0a69117e40c723&tags=${tags}&per_page=20&format=json&nojsoncallback=1`)
      .then(response => {
  ...
  callingAPICats = (tags="cats", key="8b900241c78daaf3ef0a69117e40c723".apiKey) => {
    axios.get(`https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=8b900241c78daaf3ef0a69117e40c723&tags=${tags}&per_page=20&format=json&nojsoncallback=1`)
      .then(response => {
        this.setState({
  ...
  callingAPIDogs = (tags="dogs", key="8b900241c78daaf3ef0a69117e40c723".apiKey) => {
    axios.get(`https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=8b900241c78daaf3ef0a69117e40c723&tags=${tags}&per_page=20&format=json&nojsoncallback=1`)
      .then(response => {
        this.setState({
  ...
  callingAPIComputers = (tags="computers", key="8b900241c78daaf3ef0a69117e40c723".apiKey) => {
    axios.get(`https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=8b900241c78daaf3ef0a69117e40c723&tags=${tags}&per_page=20&format=json&nojsoncallback=1`)
      .then(response => {
        this.setState({
